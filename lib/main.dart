...
void main() async{
  ...
  runApp(SkinDiseaseDetectorApp(cameras: camera,));
}

class SkinDiseaseDetectorApp extends StatelessWidget {
  final List<CameraDescription> cameras;
  const SkinDiseaseDetectorApp({super.key, required this.cameras});
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: SplashScreen(cameras: cameras), // Start with SplashScreen
    );
  }
}
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Full Name Field
                      _buildInputField('FULL NAME', 'Enter Full Name', controller: namecontroller),
                      const SizedBox(height: 15),

                      // Phone Number Field
                      _buildInputField('PHONE NUMBER', 'Enter Your Number', controller: numbercontroller),
                      const SizedBox(height: 15),

                      // Email Address Field
                      _buildInputField('EMAIL ADDRESS', 'Enter Your Email', controller: emailcontroller),
                      const SizedBox(height: 15),
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => RegPage(cameras: widget.cameras),
                                ),
                              );
                            },
                            style: ElevatedButton.styleFrom(
...
class RegPage extends StatelessWidget {
  final List<CameraDescription> cameras;
  const RegPage({super.key, required this.cameras});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
            ...
            Center(
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor:
                  Colors.teal[800], // Background color of the button
                ),
                child: const Text(
                  'NEXT',
                  style: TextStyle(
                ...
                children: [
                  ...
                  buildFeatureCard(
                    ...
                    'Assets/nearby_specialist.jpeg',
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            spec_screen(cameras: cameras), // Navigate to ProfileScreen
                      ),
                    );
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HomeScreen(cameras: cameras), // Set HomeScreen as the home widget
    );
  }
}
class spec_screen extends StatelessWidget {
  final List<CameraDescription> cameras;
  const spec_screen({super.key, required this.cameras});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF0F2C2C), // Dark background
